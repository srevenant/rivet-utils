defmodule Rivet.Utils.Time do
  ...
  {:error, :invalid_date}
  """
  @spec new_utc_date(pos_integer(), pos_integer(), pos_integer()) :: {:ok, DateTime.t()} | {:error, :invalid_date}
  @spec new_utc_date(pos_integer(), pos_integer()) :: {:ok, DateTime.t()} | {:error, :invalid_date}
